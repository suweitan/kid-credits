  ...
  <div class="h-full w-full px-4 md:px-6 pt-3 pb-8 text-teal-400">
    ...
    <div class="h-full overflow-scroll">
      <div v-for="(m,i) in movements" :key="i">
        ...
        <div v-for="(item,j) in m.items" :key="j" class="mt-2 mb-3 px-5 py-2 border border-gray-100 hover:bg-gray-800 rounded-lg flex items-center justify-between">
          <div>
