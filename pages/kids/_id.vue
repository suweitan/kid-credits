  ...
  <div class="h-full w-full px-4 md:px-6 pt-3 pb-8 bg-indigo-300">
    ...
    <div class="flex flex-col md:flex-row">
      ...
      <div class="mb-3 w-full md:w-1/4 pr-3">
        ...
        <p class="text-gray-600 leading-tight text-sm">Kid's name and give the kid a nice color and a starting credit.</p>
      </div>
      <div class="w-full md:w-3/4">
        ...
        <form class="bg-white shadow-md rounded-lg px-8 py-8 mb-4">
            ...
            <div class="flex flex-wrap items-center justify-center sm:justify-start">
              <div v-for="(c,index) in creatures" :key="index" class="p-2">
                <div class="flex flex-col">                
                  <img 
                    class="p-2 h-24 w-24 cursor-pointer bg-indigo-100 hover:bg-indigo-200 shadow-lg rounded-lg object-cover object-center"     
          ...
          <div class="mt-10 sm:mt-16 flex items-center justify-end">
            <div class="w-full flex flex-col sm:flex-row">
              <button @click="back" class="ml-0 sm:ml-auto mr-3 text-red-500 font-bold py-2 px-4 rounded-full hover:bg-red-100 focus:outline-none" type="button">
                <span class="text-sm sm:text-lg">Cancel</span>
              </button>
              <button @click.prevent="submitForm" :disabled="loading" class="mt-3 sm:mt-0 bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 sm:py-3 px-4 rounded-full focus:outline-none focus:shadow-outline inline-flex items-center justify-center" type="submit">
                <svg v-if="loading" class="animate-spin -ml-1 mr-3 h-5 w-5 text-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
                  <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
                  <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
                </svg>
                <span class="text-sm sm:text-lg">{{ submitBtn }}</span>
              </button>
            </div>
          </div>
        </form>
